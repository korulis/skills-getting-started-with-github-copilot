              ...
              <ul class="participants-list" style="list-style: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li style="display: flex; align-items: center; gap: 0.5em;">
                    <span>${email}</span>
                    <button class="delete-participant" data-activity="${name}" data-email="${email}" title="Remove participant" style="background: none; border: none; cursor: pointer; color: #c00; font-size: 1em;">
                      🗑️
                    </button>
                  </li>
                `).join("")}
